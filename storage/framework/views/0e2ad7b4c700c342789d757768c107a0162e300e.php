    ...
    <div class="app-admin-wrap-layout-1 sidebar-full sidebar-theme-slate">
                        ...
                        <nav class="sidebar-nav">
                            <ul class="metismenu show-on-load" id="ul-menu">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('admin')) : ?>
                                    <li><a class="has-arrow" href="#"><i class="material-icons nav-icon">account_balance</i>My Accounts</a>
                                        <ul class="mm-collapse">
                                            <li><a href="#"><i class="material-icons nav-icon">history</i>Transaction History</a>
                                            </li>
                                            <li><a href="#"><i class="material-icons nav-icon">receipt_long</i>Account Statment</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a class="has-arrow" href="#"><i class="material-icons nav-icon text-16">arrow_outward</i>Account
                                            Transfers</a>
                                        <ul class="mm-collapse">
                                            <li><a href="#"><i class="material-icons nav-icon">save</i>Internal</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">account_balance</i>Domestic </a>
                                            </li>
                                            <li><a href="#"><i class="material-icons nav-icon">currency_exchange</i>International
                                                </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a class="has-arrow" href="#"><i class="material-icons nav-icon text-16">credit_card</i>Cards</a>
                                        <ul class="mm-collapse">
                                            <li><a href="#"><i class="material-icons nav-icon">input</i>Card Replacement</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">credit_card_off</i>Card Hotlist</a>
                                            </li>
                                            <li><a href="#"><i class="material-icons nav-icon">error</i>Dispense Error</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">add_card</i>New Card Request</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a class="has-arrow" href="#"><i class="material-icons nav-icon text-16">settings</i>Self Service</a>
                                        <ul class="mm-collapse">
                                            <li><a href="#"><i class="material-icons nav-icon">lock</i>Password Change</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">question_answer</i>Reset Secret
                                                    Question & Answer</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">toggle_off</i>Account
                                                    Switch-Off/On</a></li>
                                            <li><a href="#"><i class="material-icons nav-icon">upgrade</i>Set Account Limit</a>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')) : ?>
                                    <li><a href="#"><i class="material-icons nav-icon text-16">home</i>Home</a></li>
                                    <li><a href="#"><i class="material-icons nav-icon text-16">add_card</i>Card Request</a></li>
                                    <li><a href="#"><i class="material-icons nav-icon text-16">input</i>Transactions</a></li>
                                    <li><a href="#"><i class="material-icons nav-icon text-16">menu_book</i>Cheque Request</a>
                                    </li>
                                    <li><a href="#"><i class="material-icons nav-icon text-16">error</i>Dispense Error</a></li>
        ...
        <div class="main-content-wrap">
            ...
            <div class="ul-mobile-top-header bg-slate">
                <a href="https://Ea-Administrator.com/">
            ...
            <div class="main-content-body">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')) : ?>
                    ...
                    <div class="bg-card px-lg py-md d-flex justify-content-center align-items-center flex-wrap shadow-6dp">
                        <p class="text-muted m-0">All rights reserved &copy; <?php echo e(\Carbon\Carbon::now()->year); ?> <?php echo e(config('app.name')); ?></p>
                    </div>
                    <!-- End:: Footer-->
                    </div>
                    <!-- End:: content body-->
