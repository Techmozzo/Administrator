                ...
                <div class="card-body">
                    ...
                    <?php if ($dispenseErrors->count() > 0) : ?>
                        <table class="table nowrap" id="datatableScrollXY" style="width:100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $dispenseErrors;
                                ...
                                foreach ($__currentLoopData as $request) : $__env->incrementLoopIndices();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm" href="<?php echo e(url('/admin/dispense-errors/' . $hashIds->encode($request->id))); ?>" title="Edit Request">Edit</a>
                                            &nbsp;
