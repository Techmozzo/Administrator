                ...
                <div class="card-header d-flex jusitify-space-between">
                    ...
                    <div>
                        <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm"
                            href="<?php echo e(route('banks.create')); ?>" title="Add Bank">Add Bank</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chukwuemekainya/Sites/Techmozzo/audit-confirmation/admin/resources/views/banks/index.blade.php ENDPATH**/ ?>