            ...
            <div class="scroll-nav" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <div class="app-user text-center">
                    <div class="app-user-photo">
                        <?php if(auth()->user()->gender == 'felmale'): ?>
                    ...
                    <div class="app-user-info"><span class="app-user-name"><?php echo e(auth()->user()->name); ?></span>
                        <div class="app-user-control">
                            ...
                            <a class="control-item" href="<?php echo e(route('help-center')); ?>"><i class="material-icons">
                                    email</i></a>
                            <a class="control-item" href="<?php echo e(route('logout')); ?>"><i
                    ...
                    <div class="main-menu">
                        <nav class="sidebar-nav">
                            <ul class="metismenu show-on-load" id="ul-menu">
                                <li><a class="control-item" href="<?php echo e(route('home')); ?>" title="Home"><i
                                            class="material-icons nav-icon text-16">home</i>Home</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('banks.index')); ?>" title="Banks"><i
                                            class="material-icons nav-icon text-16">account_balance</i>Banks</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('companies.index')); ?>" title="Companies"><i
                                            class="material-icons nav-icon text-16">people</i>Companies</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('home')); ?>" title="Requests"><i
                                            class="material-icons nav-icon text-16">pending_actions</i>Requests</a>
                                </li>
                                ...
                                <li><a class="control-item" href="<?php echo e(route('help-center')); ?>" title="Help Center"><i
                                            class="material-icons nav-icon text-16">help</i>Help</a>
                                </li>


                                <li><a class="control-item" href="<?php echo e(route('logout')); ?>"
                        ...
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link"
                                        href="<?php echo e(route('home')); ?>">Dashboards</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="subheader-container">
                            <div class="subheader-main d-none d-lg-flex">
                                <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                    <ol class="ul-breadcrumb-items">
                                        <li class="breadcrumb-home"><a href="<?php echo e(route('home')); ?>"> <i
                            ...
                            <?php if(request()->routeIs('admin.faqs.index')): ?>
                                <div class="subheader-toolbar"><a class="btn btn-opacity-primary btn-sm mr-2"
                                        href="<?php echo e(route('faqs.create')); ?>">Add new FAQ </a>
                                <?php else: ?>
                                        ...
                                        <?php switch(auth()->user()):
                                            ...
                                            <?php case (auth()->user()->verified == 2): ?>
                                                <a class="btn btn-opacity-danger btn-sm mr-2"
                                                    href="<?php echo e(route('validation.index')); ?>">
...
<?php /**PATH /Users/chukwuemekainya/Sites/Techmozzo/audit-confirmation/admin/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>