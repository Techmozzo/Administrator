...
<?php $__env->startSection('custom_content'); ?>
    ...
    <div class="container my-lg d-flex flex-column">
        <div class="card-header d-flex jusitify-space-between">
            <h2 class="p-1 m-0 text-16 font-weight-semi">Edit <?php echo e($company->name); ?></h2>
            <div class="flex-grow-1"></div>
            <div>
                <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm" href="<?php echo e(route('companies.index')); ?>"
                    title="Back">Back</a>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" id="website"
                            name="website" value="<?php echo e($company->website); ?>" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php $__errorArgs = ['administrator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="administrator_id"
                            id="administrator_id">
                            <?php $__currentLoopData = $administrators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $administrator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($administrator->id); ?>"
                                    <?php echo ($company->administrator_id == $administrator->id)? 'selected':''; ?>>
                                    <?php echo e($administrator->name()); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="country"
                            name="country" value="<?php echo e($company->country); ?>" />
...
unset($__errorArgs, $__bag); ?>" id="zip"
                            name="zip" value="<?php echo e($company->zip); ?>" />
                        <?php $__errorArgs = ['zip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chukwuemekainya/Sites/Techmozzo/audit-confirmation/admin/resources/views/companies/edit.blade.php ENDPATH**/ ?>