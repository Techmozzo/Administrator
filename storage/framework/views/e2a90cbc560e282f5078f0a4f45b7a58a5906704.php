                    ...
                    <div class="main-menu">
                        <nav class="sidebar-nav">
                            <ul class="metismenu show-on-load" id="ul-menu">
                                <li><a class="control-item" href="<?php echo e(route('home')); ?>" title="Home"><i class="material-icons nav-icon text-16">home</i>Home</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('banks.index')); ?>" title="Banks"><i class="material-icons nav-icon text-16">account_balance</i>Banks</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('companies.index')); ?>" title="Companies"><i class="material-icons nav-icon text-16">people</i>Companies</a>
                                </li>

                                <li><a class="control-item" href="<?php echo e(route('home')); ?>" title="Requests"><i class="material-icons nav-icon text-16">pending_actions</i>Requests</a>
                                </li>
...
<?php /**PATH /Users/chukwuemekainya/Sites/audit-confirmation/admin/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>