    ...
    <div class="row">
        <div class="col-lg-12 mb-md">
            <div class="card-header">
                <h2 class="p-1 m-0 text-16 font-weight-semi">Card Request</h2>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="mt-l mb-lg"></div>

                    <?php if ($cardRequests->count() > 0) : ?>
                        <table class="table nowrap" id="datatableScrollXY" style="width:100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $cardRequests;
                                ...
                                foreach ($__currentLoopData as $request) : $__env->incrementLoopIndices();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm" href="<?php echo e(url('/admin/card-requests/' . $hashIds->encode($request->id))); ?>" title="Edit Request">Edit</a>
                                            &nbsp;
                    ...
                    <?php else : ?>
                        <div class="text-danger text-center">There is no card request</div>
                    <?php endif; ?>
...
<script>
    $('document').ready(function() {
        $('.delete-item').on('click', function() {
            ...
            var url = '/admin/card-requests/' + itemId + '/delete'
            confirmAction(url);
        })
    })
</script>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chukwuemekainya/Sites/ibank/resources/views/admin/cards/request.blade.php ENDPATH**/ ?>