    ...
    <div class="form-holder signin-2 px-xxl">
        <div data-perfect-scrollbar='' data-suppress-scroll-x='true'>
            <div class="d-flex flex-column align-items-center mt-lg mb-xxl">
                <a href="https://Ea-Administrator.com/"><img class="card-img-top signup"
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Email Address" value="<?php echo e(old('email')); ?>" aria-label="email" required
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Password" value="<?php echo e(old('password')); ?>" aria-label="Password"
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chukwuemekainya/Sites/Techmozzo/audit-confirmation/admin/resources/views/auth/login.blade.php ENDPATH**/ ?>