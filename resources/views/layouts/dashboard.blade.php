                    ...
                    <div class="main-menu">
                        <nav class="sidebar-nav">
                            <ul class="metismenu show-on-load" id="ul-menu">
                                <li><a class="control-item" href="{{ route('home') }}" title="Home"><i
                                            class="material-icons nav-icon text-16">home</i>Home</a>
                                </li>

                                <li><a class="control-item" href="{{ route('banks.index') }}" title="Banks"><i
                                            class="material-icons nav-icon text-16">account_balance</i>Banks</a>
                                </li>

                                <li><a class="control-item" href="{{ route('companies.index') }}" title="Companies"><i
                                            class="material-icons nav-icon text-16">people</i>Companies</a>
                                </li>

                                <li><a class="control-item" href="{{ route('home') }}" title="Requests"><i
                                ...
                                <li><a class="has-arrow" href="#"><i
                                    ...
                                    <ul class="mm-collapse">
                                        <li><a href="#"><i class="material-icons nav-icon">lock</i>Password
                                                Change</a></li>
                                        {{-- <li><a href="#"><i
                                                        class="material-icons nav-icon">toggle_off</i>Account
                                                    Switch-Off/On</a></li>
                                            <li><a href="#"><i
                                                        class="material-icons nav-icon">upgrade</i>Set Account Limit</a>
                                            </li> --}}
                                    </ul>
                                </li>
